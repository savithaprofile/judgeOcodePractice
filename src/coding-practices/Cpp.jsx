...
const Cpp = () => {
  ...
  const defaultCodes = [
    ...
    `#include <iostream>\nusing namespace std;\n\nint main() {\n    int n;\n    cin >> n;\n    int arr[n], maxVal;\n    for(int i = 0; i < n; i++) {\n        cin >> arr[i];\n        if(i == 0 || arr[i] > maxVal) maxVal = arr[i];\n    }\n    cout << maxVal << endl;\n    return 0;\n}`,
    `#include <iostream>\nusing namespace std;\n\nint main() {\n    int a, b;\n    cin >> a >> b;\n    while(b != 0) {\n        int temp = b;\n        b = a % b;\n        a = temp;\n    }\n    cout << a << endl;\n    return 0;\n}`
  ];
      ...
      <div className="app">
        <div className="completion-screen">
          ...
          <div className="score-card">
            ...
            <p>Thank you for completing the coding challenge!</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="editor-section">
          <div className="editor-header">
            ...
            <div className="editor-buttons">
              ...
              <button onClick={()=>setCode(defaultCodes[currentQuestion])} disabled={isLoading}>Show Code</button>
            </div>
          </div>
