...
const Java = () => {
  ...
  const questions = [
    ...
    },
    {
      id: 9,
      title: "Find Maximum",
      description: "Write a program to find the maximum number in an array.",
      testCases: [
    ...
    return (
      <div className="app">
        <div className="completion-screen">
          ...
          <h2>You've completed all Java questions!</h2>
          <div className="score-card">
            <h3>Final Score: {score} / {questions.length}</h3>
            <p>You've demonstrated strong Java programming skills!</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className="app">
      ...
      <div className="content">
        <div className="question-section">
          ...
          <div className="java-requirements">
            <h4>Java Requirements:</h4>
            <ul>
              <li>Use <code>public class Main</code> as the main class</li>
              <li>Include <code>public static void main(String[] args)</code> method</li>
              <li>Use <code>Scanner</code> for input reading</li>
              <li>Make sure to import required packages</li>
            </ul>
          </div>
        ...
        <div className="editor-section">
          ...
          <textarea
            ...
            placeholder={`Write your Java code here...\nRemember to use public class Main and proper Scanner usage.`}
            disabled={isLoading}
            rows={15}
          />
          
          <div className="java-tips">
            <h4>Java Tips:</h4>
            <ul>
              <li>Always use <code>public class Main</code> as your main class</li>
              <li>Include the main method: <code>public static void main(String[] args)</code></li>
              <li>Use <code>Scanner scanner = new Scanner(System.in);</code> for input</li>
              <li>Import required packages (<code>import java.util.Scanner;</code>)</li>
              <li>Close Scanner if needed to avoid resource leaks</li>
            </ul>
          </div>
          
          <div className="output-section">
            <h4>Output:</h4>
            <pre className="output">{isLoading ? 'Compiling and running...' : output}</pre>
          </div>
        </div>
      </div>
    </div>
